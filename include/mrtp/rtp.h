#ifndef __MRTP_RTP_H__
#define __MRTP_RTP_H__
...
#define rtp_set_markbit(mp,value)		((rtp_header_t*)((mp)->rptr))->markbit=(value)
#define rtp_set_seqnumber(mp,seq)	((rtp_header_t*)((mp)->rptr))->seq_number=(seq)
#define rtp_set_timestamp(mp,ts)	((rtp_header_t*)((mp)->rptr))->timestamp=(ts)
#define rtp_set_ssrc(mp,_ssrc)		((rtp_header_t*)((mp)->rptr))->ssrc=(_ssrc)
#define rtp_set_payload_type(mp,pt)	((rtp_header_t*)((mp)->rptr))->paytype=(pt)

#define rtp_get_version(mp)	(((rtp_header_t*)((mp)->rptr))->version)
#define rtp_get_markbit(mp)	(((rtp_header_t*)((mp)->rptr))->markbit)
#define rtp_get_extbit(mp)	(((rtp_header_t*)((mp)->rptr))->extbit)
#define rtp_get_timestamp(mp)	(((rtp_header_t*)((mp)->rptr))->timestamp)
#define rtp_get_seqnumber(mp)	(((rtp_header_t*)((mp)->rptr))->seq_number)
#define rtp_get_payload_type(mp)	(((rtp_header_t*)((mp)->rptr))->paytype)
#define rtp_get_ssrc(mp)		(((rtp_header_t*)((mp)->rptr))->ssrc)
#define rtp_get_cc(mp)		(((rtp_header_t*)((mp)->rptr))->cc)
#define rtp_get_csrc(mp, idx)		(((rtp_header_t*)((mp)->rptr))->csrc[idx])
#define rtp_get_header_size(mp)	(RTP_FIXED_HEADER_SIZE + (rtp_get_cc(mp)*4))

#ifdef __cplusplus
extern "C" {
#endif

MRTP_PUBLIC void rtp_add_csrc(mblk_t* mp,uint32_t csrc);
MRTP_PUBLIC int rtp_get_payload(mblk_t *packet, byte_t **start);
MRTP_PUBLIC int rtp_get_extheader(mblk_t *packet, uint16_t *profile, byte_t **start_ext);
